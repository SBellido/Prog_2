...
public class MainNursery {
	...
	public static void main(String[] args) {
		...
		Plant plant3 = new Plant("Apipremnum aureum", "Ipipremnum", "Iraceae", "Oonocotyledoneae", false, 2, 5);
		Plant plant4 = new Plant("Epipremnum aureum", "Opipremnum", "Eraceae", "Uonocotyledoneae", true, 30, 2);
		Plant plant5 = new Plant("Upipremnum aureum", "Upipremnum", "Araceae", "Aonocotyledoneae", false, 10, 15);
		...
		System.out.println(nurseryAdmin.orderPlant(comparator1));
