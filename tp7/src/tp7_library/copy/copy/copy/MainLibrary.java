...
public class MainLibrary {
	...
	public static void main(String[] args) {
		...
		Comparator<Book> comparator1 = new ComparatorAutor();
		Comparator<Book> comparator2 = new ComparatorMainGender();
		
		
		library.setComparatorBook(comparator2);
		System.out.println(library.orderBooksReverse());
